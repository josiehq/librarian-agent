"""
A2 Josie - MCP Communication Rules
Workflow Orchestration

This module defines how Josie communicates with the MCP server
...
PHASE_BEHAVIORS = {
    4: {
        ...
        "subordinates": [],
        "responsibilities": [
            "Real-time workflow orchestration and execution monitoring"
        ]
    }
}
