"""
D2 Diplo - MCP Communication Rules
Memory & Logging Daemon

This module defines how Diplo communicates with the MCP server
...
PHASE_BEHAVIORS = {
    1: {
        "tools": ['github_narnia_mcp', 'caching_engine'],
        "subordinates": [],
        "responsibilities": [
            "Full-time logging, caching, and memory management"
        ]
    }
}
