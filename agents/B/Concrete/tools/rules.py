"""
B3 Concrete - MCP Communication Rules
Data Validation & Testing

This module defines how Concrete communicates with the MCP server
and what tools/capabilities it has access to.
"""

AGENT_INFO = {
    "agent_id": "B3-Concrete",
    "class": "B",
    "rank": "B3",
...
PHASE_BEHAVIORS = {
    2: {
        ...
        "subordinates": [],
        "responsibilities": [
            "Visual Sovereign testing with Amazon MCP integration"
        ]
    }
}
