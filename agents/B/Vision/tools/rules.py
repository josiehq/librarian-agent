"""
B2 Vision - MCP Communication Rules
Visual Design & Prototyping

This module defines how Vision communicates with the MCP server
...
PHASE_BEHAVIORS = {
    2: {
        ...
        "subordinates": [],
        "responsibilities": [
            "Figma integration for UI/UX design and asset management"
        ]
    }
}
