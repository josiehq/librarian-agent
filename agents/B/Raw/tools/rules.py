"""
B1 Raw - MCP Communication Rules
Web Automation & Scraping

This module defines how Raw communicates with the MCP server
...
AVAILABLE_TOOLS = {
    "selenium_playwright_mcp": {
        "name": "selenium_playwright_mcp",
        "agent": "B1-Raw"
    },
}
...
PHASE_BEHAVIORS = {
    2: {
        ...
        "subordinates": [],
        "responsibilities": [
            "Browser automation and raw-to-structured data conversion"
        ]
    }
}
...
if __name__ == "__main__":
    ...
    request = build_mcp_request(
        method="selenium_playwright_mcp",
        params={"action": "test"}
    )
